...
var _SuggestiontButton = _interopRequireDefault(require("../Buttons/SuggestiontButton"));
var _excluded = ["fancyScroll", "children", "forwardedRef"],
  _excluded2 = ["value", "onSend", "onChange", "autoFocus", "placeholder", "fancyScroll", "className", "activateAfterChange", "disabled", "sendDisabled", "sendOnReturnDisabled", "attachDisabled", "suggestionDisabled", "sendButton", "attachButton", "suggestionButton", "onAttachClick", "onSuggestionClick"];
...
function MessageInputInner(_ref, ref) {
  ...
  }), suggestionButton === true && /*#__PURE__*/_react["default"].createElement("div", {
    className: "".concat(cName, "__tools")
  }, /*#__PURE__*/_react["default"].createElement(_SuggestiontButton["default"], {
